...
function Home() {
  return (
    ...
    <div className="container">
     ...
     <a href="">
      <img style={{marginTop:'130px',borderRadius:'50%'}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9EhdjDyKiPklzklEAf351YMC9B0c6STOr5m5pNWbeH9yvv5S1whaw3oZF2mryQoSN340&usqp=CAU" width={'200px'} className='d-block mx-auto' alt="" />
     </a>
     <h3 className='text-center text-light'>Welcome to our world of beauty</h3>
      </div>
    </div>
    </header>
...
<h1 className='primary-color '>"Skincare is a journey, Enjoy the process"</h1>
<p className='text-justify justify-content-evenly m-3 p-3'>
 <span style={{color:' #b6e9eb',fontSize:'25px'}}>Magic Touch</span> Salon is located in Ernakulam,Vyttila since the year 2019.
  Magic Touch offers a range of high-quality services ranging from hair coloring,facials,haircuts,waxing and many other
   services. One of the striking features about Magic Touch is its expert people and staff. <br /> <br /> The highly experienced 
   and skilled hairstylists help you to get the best haircut suiting your demand. You can also get a personalized
    recommendation and consultation that will fit your style. Skincare products used in our services are thoughtfully
    handcrafted, in small batches,using the highest quality ingredients.
</p>
        </div>
        {/* right side */}
        <div className='col-md-6 right'>
 <img className='w-100' src="https://media.istockphoto.com/id/692814140/photo/young-attractive-brunette-with-voluminous-shiny-and-curly-hairstyle.jpg?s=612x612&w=0&k=20&c=bBwh2U0AtUCxlWIY67rKZBp3BldMPPrwfxIIFUlJeYM=" alt="" />
        </div>
...
<p className='text-justify'>
    ...
    <div className='scrollEffect'  id='img1'></div>
  ...
  <img width={'250px'} src="https://static.wixstatic.com/media/1e47b2_8f709af9d3744b8c8ac17f27366df93a.jpg/v1/fill/w_235,h_235,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/1e47b2_8f709af9d3744b8c8ac17f27366df93a.jpg" alt="" />
 
  <div class="card__content ">
    <p class="card__title mt-3">Facials</p>
    <p class="card__description mt-2">
      "Your skin should glow as bright as your soul does"
...
<section id="card1" class="card">
  <img width={'250px'} src="https://t4.ftcdn.net/jpg/04/79/07/85/360_F_479078572_n3YvxwTTBW94TzlPDcCiTCJxG4lWKXCv.jpg" alt="" />
  <div class="card__content ">
    <p class="card__title mt-3">Waxing</p>
    <p class="card__description mt-2">
...
<section id="card1" class="card">
  <img width={'250'} src="https://static.wixstatic.com/media/1e47b2_3e10f00d758d437c8025127b98a2892d.jpg/v1/fill/w_235,h_235,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/1e47b2_3e10f00d758d437c8025127b98a2892d.jpg" alt="" />
  <div class="card__content ">
    <p class="card__title mt-3">Hair Care</p>
    <p class="card__description mt-2">
    "Your hair is an extention of your personality"
    <Link  to={'/login'}>
        <button className='mt-4'>
  Book Now
  <div class="icon-1">
  ...
  <svg
    ...
    >
     ...
     <div className='scrollEffect '  id='img2'></div>
     <div className="block">
      {/* card */}
      <h2 className='text-center m-3' id='testimonials' >Testimonials</h2>
      <section class="h-50 w-100 bg-light">
  <div class="container  h-50" style={{marginTop:'80px'}}>
    <div class="row d-flex justify-content-center align-items-center h-50 ">
      <div class="col-12">

        <div class="card text-white"  style={{backgroundColor:' #abd6d8',borderRadius:'15px'}} >
          <div class="card-body p-2" style={{height:'340px'}}>

            <i class="fas fa-quote-left fa-2x mb-4 "></i>

            <p class="lead" style={{color:'black'}}>The staff is friendly,warm, and cooperative.They greet me with happy faces 
            all the time. Love this place and its atmosphere.</p>

            <div class="d-flex justify-content-between">
              <p class="fs-4 text-primary">Michellle Sebastian</p>
              <h6 class="mb-0"><span class="badge rounded-pill"
                 style={{backgroundColor:'rgba(0,0,0, 0.2)'}}>276</span> <i class="fas fa-heart text-danger ms-2"></i>
              </h6>
            </div>
      ...
      <div class="col-12">
        ...
        <div class="card text-white"  style={{backgroundColor:'#abd6d8',borderRadius:'15px'}} >
          <div class="card-body p-2" style={{height:'340px'}}>
            ...
            <p class="lead" style={{color:'black'}}>Loved it! Great haircuts, fantastic services, love the atmosphere.
             Will definitely be back here. </p>

            <div class="d-flex justify-content-between mt-5">
              <p class="fs-4 text-primary">Rea Benedict</p>
              <h6 class="mb-0"><span class="badge rounded-pill"
                 style={{backgroundColor:'rgba(0,0,0, 0.2)'}}>456</span> <i class="fas fa-heart text-danger ms-2"></i>
              </h6>
            </div>
...
<section class="h-50 w-100 bg-light">
  <div class="container h-50" style={{marginTop:'80px'}}>
    <div class="row d-flex justify-content-center align-items-center h-50 ">
      <div class="col-12">
        ...
        <div class="card text-white"  style={{backgroundColor:' #abd6d8',borderRadius:'15px'}} >
          <div class="card-body p-2" style={{height:'340px'}}>
            ...
            <p class="lead" style={{color:'black'}}>My experience at Magic Touch was absolutely AMAZING!!! The salon is beautiful, 
            each station was clean & tidy! Pricing is more than reasonable.</p>

            <div class="d-flex justify-content-between">
              <p class="fs-4 text-primary">Sera Francis</p>
              <h6 class="mb-0"><span class="badge rounded-pill"
                 style={{backgroundColor:'rgba(0,0,0, 0.2)'}}>306</span> <i class="fas fa-heart ms-2 text-danger"></i>
              </h6>
            </div>
     ...
     <div className='scrollEffect' id='img3'></div>
     
      {/* <Link to='/login'>
        <div className='text-center'>
        <button className='btn btn-dark btn-lg px-5 text-center text-white shadow m-4 rounded-pill ' >GET STARTED</button>
        </div>
  ...
  <div class="form-card2">
    <form class="form" id='contact'>
      <h3 className='text-center mt-4'>Visit Us</h3>
      <p className='text-center'>Ground Floor, Thoppil Estate, Sahodhaya Rd, Janatha, Vyttila, Ernakulam,
       Kerala 682019 <br /> magictouch@gmail.com \ Ph: 8901562816</p>
       
       <p className='text-center'>OPENING HOURS <br />
        Mon - Fri: 7am - 10pm \ Saturday: 8am - 10pm \ Sunday: 8am - 11pm</p>
